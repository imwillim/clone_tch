...
# incrementally modify your database, and then regenerate this contracts definition.
#
# This file is the source Rails uses to define your contracts when running `bin/rails
# db:contracts:load`. When creating a new database, `bin/rails db:contracts:load` tends to
